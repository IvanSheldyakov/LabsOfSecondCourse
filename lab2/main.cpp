...
TEST(test1, TestOfInsert) {
    Value* value1 = new Value(1,2,"key1");
    Value* value2 = new Value(2,3,"key2");
    Value* value3 = new Value(3,4,"key3");
    Value* value4 = new Value(4,5,"key4");
    Value* value5 = new Value(5,6,"key5");
    Value* value6 = new Value(6,7,"key3");
